...
class CollegeAdmissionChatbot(QtWidgets.QWidget):
    ...
    def calculate_cutoff(self):
        ...
        try:
            ...
            if maths_marks < 34 or maths_marks > 100 or physics_marks < 34 or physics_marks > 100 or chemistry_marks < 34 or chemistry_marks > 100:
                self.result_label.setText('Invalid marks! Marks should be between 35 and 100.')
                return
